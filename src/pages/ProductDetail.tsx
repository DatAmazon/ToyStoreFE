    ...
    <div className="min-h-screen bg-[#FCF8F9]">
      ...
      <div className="container mx-auto px-4 py-6 md:py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          >
            <div className="p-2 rounded-full bg-white border border-border group-hover:border-primary/30 group-hover:bg-primary/5 transition-all">
              <ChevronLeft size={18} />
            </div>
            Quay lại
          </button>
          <div className="flex gap-2">
            <button className="p-2.5 rounded-full bg-white border border-border text-muted-foreground hover:text-primary transition-all shadow-sm">
              <Share2 size={18} />
            </button>
            <button className="p-2.5 rounded-full bg-white border border-border text-muted-foreground hover:text-primary transition-all shadow-sm">
              <Heart size={18} />
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="bg-white rounded-[2rem] border border-border p-8 md:p-10 shadow-sm flex-1">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="flex items-center gap-1 text-[10px] font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full uppercase">
              ...
              <div className="flex items-center gap-6 mb-8">
                ...
                <div className="text-sm font-bold text-muted-foreground border-l border-border pl-6">
                  <span className="text-foreground">{product.reviews}</span> Đánh giá
                </div>
                <div className="text-sm font-bold text-muted-foreground border-l border-border pl-6">
                  <span className="text-foreground">500+</span> Đã bán
                </div>
              </div>
              ...
              <div className="bg-secondary/30 rounded-3xl p-8 mb-8 border border-border/50 relative overflow-hidden">
                <div className="absolute top-0 right-0 p-4 opacity-10">
                  <Zap size={80} className="text-primary" fill="currentColor" />
                </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-10">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-pink-50 flex items-center justify-center text-primary border border-pink-100">
                    <Award size={20} />
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-muted-foreground uppercase">Thương hiệu</p>
                    <p className="text-sm font-black text-foreground">{product.manufacturer}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] font-bold text-muted-foreground uppercase">Độ tuổi</p>
                    <p className="text-sm font-black text-foreground">{product.minimumAge}+ tuổi</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <button 
                    ...
                    className="flex-1 h-14 bg-primary text-white font-black rounded-2xl shadow-lg shadow-primary/20 hover:bg-primary-dark transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3"
                  >
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              {[
                { icon: ShieldCheck, label: "Thủ công 100%", sub: "Đan móc tỉ mỉ" },
                { icon: Truck, label: "Giao hàng nhanh", sub: "Toàn quốc 2-4 ngày" },
                { icon: RotateCcw, label: "Bảo hành mẫu mã", sub: "Đổi trả miễn phí" }
              ].map((item, idx) => (
                <div key={idx} className="bg-white border border-border p-4 rounded-2xl flex flex-col items-center text-center gap-2">
                  <item.icon className="text-primary h-5 w-5" />
                  <div>
                    <p className="text-[10px] font-black uppercase text-foreground">{item.label}</p>
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="bg-white rounded-[2rem] border border-border p-8 md:p-10 shadow-sm">
              ...
              <div className="prose prose-pink max-w-none text-muted-foreground leading-relaxed space-y-6">
                <p className="text-lg text-foreground/80 italic font-medium">
                  "{product.name} không chỉ là một món đồ chơi, mà là người bạn đồng hành ấm áp được đan dệt từ sự kiên nhẫn và tình yêu thương tại Gia Đình Thỏ Xinh."
                </p>
                <p>
                  Từng mũi móc được thực hiện bằng sợi <span className="text-primary font-bold">len Milk Cotton</span> cao cấp, mang lại cảm giác vô cùng mềm mại và đặc biệt an toàn cho làn da nhạy cảm của bé. Sản phẩm có độ bền cao, không bị xù lông hay biến dạng sau nhiều lần giặt.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-10">
                  <div className="space-y-4">
                    <h4 className="font-black text-foreground flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-primary" /> Đặc điểm nổi bật
                    </h4>
                  ...
                  <div className="space-y-4">
                    <h4 className="font-black text-foreground flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-primary" /> Cách bảo quản
                    </h4>
                    <ul className="space-y-3 text-sm font-medium">
                ...
                <p>
                  Sở hữu món đồ handmade này là bạn đang ủng hộ những giá trị thủ công truyền thống và mang lại niềm vui nhỏ bé nhưng đầy ý nghĩa cho những người thợ móc len tâm huyết.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-primary/5 rounded-[2rem] border border-primary/10 p-8">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <div className="w-6 h-6 rounded-full bg-white flex items-center justify-center text-primary shadow-sm"><Check size={12} strokeWidth={4} /></div>
                  <p className="text-xs font-bold text-foreground/80">Hình ảnh thực tế 100% tự chụp</p>
                </li>
                <li className="flex gap-3">
                  <div className="w-6 h-6 rounded-full bg-white flex items-center justify-center text-primary shadow-sm"><Check size={12} strokeWidth={4} /></div>
                  <p className="text-xs font-bold text-foreground/80">Đổi trả nếu không giống mô tả</p>
                </li>
                <li className="flex gap-3">
                  <div className="w-6 h-6 rounded-full bg-white flex items-center justify-center text-primary shadow-sm"><Check size={12} strokeWidth={4} /></div>
                  <p className="text-xs font-bold text-foreground/80">Đóng gói hộp quà xinh xắn</p>
                </li>
              </ul>
            </div>
          </div>
