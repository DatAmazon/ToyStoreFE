  ...
  return (
    ...
    >
      <div className="p-8 sm:p-10">
        <h2 className="text-2xl font-bold text-center text-black mb-10 tracking-tight">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="auth-modal-input-group">
            ...
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#E5528F] transition-colors p-1"
            >
          ...
          <div className="flex justify-start pt-6">
            <button 
              ...
              className="text-[#E5528F] font-bold text-sm uppercase hover:underline tracking-wider transition-all"
            >
